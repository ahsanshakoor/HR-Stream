    ...
    $(document).ready(function () {
        ...
        var addTask = function () {
            ...
            if (newTask === '') {
                ...
                // let userEditURL = $(this).attr('data-TaskAdd');
                // alert(userEditURL)
        ...
        // Add assignee to task on click of add assignee button
        $('#task-list').on('click', '.task-action-btn .assignee-btn', function () {
            let userEditURL = $(this).attr('data-ProjectTask');
            $.ajax({
                type: 'GET',
                url: userEditURL,
                data: {},
                success: function (response) {
                    let form_string = response["project_task_modal"];
                    $('#assignee-form').html(form_string);
                    $('#assignee').modal('show');
                },
         ...
         // Add assignee to task on click of add assignee button pending
        $('#task-list-pending').on('click', '.task-action-btn .assignee-btn', function () {
            let userEditURL = $(this).attr('data-ProjectTask');
            $.ajax({
                type: 'GET',
                url: userEditURL,
        ...
        $('#task-list').on('click', '.task-action-btn .delete-btn', function () {
             let userEditURL = $(this).attr('data-TasktDelete');
            $.ajax({
                type: 'GET',
                url: userEditURL,
                data: {},
         ...
         // Deletes task on click of delete button pending
        $('#task-list-pending').on('click', '.task-action-btn .delete-btn', function () {
             let userEditURL = $(this).attr('data-TasktDelete');
            $.ajax({
                type: 'GET',
                url: userEditURL,
         ...
         // Deletes task on click of delete button complete
        $('#task-list-complete').on('click', '.task-action-btn .delete-btn', function () {
             let userEditURL = $(this).attr('data-TasktDelete');
            $.ajax({
                type: 'GET',
                url: userEditURL,
        ...
        $('#task-list').on('click', '.task-action-btn .complete-btn', function () {
            let userEditURL = $(this).attr('data-TasktEdit');
            // alert(userEditURL)
            $.ajax({
                type: 'GET',
                url: userEditURL,
          ...
          // Marks a task as complete pending
        $('#task-list-pending').on('click', '.task-action-btn .complete-btn', function () {
            let userEditURL = $(this).attr('data-TasktEdit');
            // alert(userEditURL)
            $.ajax({
                type: 'GET',
         ...
         // Marks a task as complete completed
        $('#task-list-complete').on('click', '.task-action-btn .complete-btn', function () {
            let userEditURL = $(this).attr('data-TasktEdit');
            $.ajax({
                type: 'GET',
                url: userEditURL,
        ...
        // Open Chat
        $('#task-list').on('click', '.task-label', function () {
            let userEditURL = $(this).attr('data-ChatModat');
            $.ajax({
                type: 'GET',
                url: userEditURL,
                data: {},
            success: function (response) {
                let form_string = response["chat-modal"];
                $('#task_window').html(form_string);
            },
              });
        });
